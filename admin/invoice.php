            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="./invoice.php">
                                <span data-feather="file"></span>
                                Invoice
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./senders.php">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-5 mb-3 clearfix">
                                    <h3 class="pull-left">To Keep track of invoices and billings based on the delivery services rendered</h3>
                                </div>
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Total Amount(s) Paid</th>
                                            <th>Total Amount(s) Unpaid</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        foreach ($result as $product) {
                                            echo "<tr>
                                                    ...
                                                    <td>" . $product['num_packages'] . "</td>
                                                    <td>" . $product['total_price'] . "</td>
                                                    <td>" . $product['total_paid'] . "</td>
                                                    <td>" . $product['total_unpaid'] . "</td>";
                                                "</tr>";
                                        }
                                        ?>
                                    </tbody>
